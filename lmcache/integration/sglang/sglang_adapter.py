...
class LMCacheConnector:
    ...
    def load_kv(self, load_metadata: LoadMetadata) -> int:
        ...
        slot_mapping = load_metadata.slot_mapping.to(get_device_name())
        ...
        slot_mapping = slot_mapping.to(get_device_name())
    ...
    def store_kv(self, store_metadata: StoreMetadata) -> None:
        ...
        slot_mapping = store_metadata.kv_indices.to(torch.int64).to(get_device_name())
