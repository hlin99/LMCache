...
class StubDeviceProperties:
    """Stub for torch.cuda.get_device_properties() return value."""
...
class StubEvent:
    ...
    def __repr__(self) -> str:
        return (
            f"StubEvent(interprocess={self.interprocess}, "
...
class StubCPUDevice:
    """Stub stand-in for torch.cuda / torch.xpu in CPU-only test environments."""
    ...
    def __getattr__(self, name: str):
        raise AttributeError(
            f"StubCPUDevice does not implement '{name}'"
        )
