...
def test_device_ext_uses_override_backend_when_provided() -> None:
    """DeviceExt honors DeviceInfo.pin_memory_backend override."""
...
def test_deleted_base_pin_memory_module_is_not_importable() -> None:
    """Legacy module path remains removed with no compatibility shim."""
    with pytest.raises(ModuleNotFoundError):
        importlib.import_module("lmcache.v1.platform.base_pin_memory")
