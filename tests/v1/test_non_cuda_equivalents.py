...
def scenario_encode_fast_new(ops: Any, device: torch.device) -> dict[str, torch.Tensor]:
...
def scenario_decode_fast_new(ops: Any, device: torch.device) -> dict[str, torch.Tensor]:
